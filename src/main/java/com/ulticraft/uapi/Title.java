	...
	public void send(Player player)
	{
		...
		if(this.packetTitle != null)
		{
			...
			try
			{
				...
				Object packet = this.packetTitle.getConstructor(this.packetActions, this.chatBaseComponent, Integer.TYPE, Integer.TYPE, Integer.TYPE).newInstance(actions[2], null, this.fadeInTime, this.stayTime, this.fadeOutTime);
